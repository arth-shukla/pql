...
def main(cfg: DictConfig):
    ...
    for iter_t in count():
        ...
        log_info = {
            ...
            "train/success_once": pql_actor.sonce_tracker.mean(),
            "train/success_at_end": pql_actor.send_tracker.mean(),
        }
        ...
        if iter_t % cfg.algo.log_freq == 0:
            time_logs = {
                f"time/{k}": v for k, v in timer.get_time_logs(global_steps).items()
            }
